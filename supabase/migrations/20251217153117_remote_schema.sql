...
CREATE POLICY "public can read instruments" ON "public"."instruments" FOR SELECT TO "authenticated", "anon" USING (true);
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."instruments" TO "postgres";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."instruments" TO "anon";
...
GRANT ALL ON SEQUENCE "public"."instruments_id_seq" TO "postgres";
